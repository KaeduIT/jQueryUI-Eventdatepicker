...
$.extend(Datepicker.prototype, {
	...
	/* Class name added to elements to indicate configured with events. */
	eventsMarkerClassName: 'hasDatepickerEvents',
...
//		if (EventDatepicker.eventsList != '' && EventDatepicker.eventsList != undefined) {
//			inst.input.addClass(this.eventsMarkerClassName);
//			console.log(EventDatepicker.eventsList);
			...
			if(EventDatepicker.eventsList.Data != undefined && EventDatepicker.eventsList.Data.length > 0)
			{
				for (var i = 0; i < EventDatepicker.eventsList.Data.length; i++) {
					if (EventDatepicker.eventsList.Data[i].EventDate == EventDatepicker.matchDateFormatted || (EventDatepicker.eventsList.Data[i].IsAnnual == 1 && EventDatepicker.eventsList.Data[i].EventDate.slice(0,-5) == EventDatepicker.annualDateFormatted) ) {
						...
						//console.log(EventDatepicker.eventsList.Data[i].EventDesc);
...
//alert('#eventdatepicker');
//console.log(inst.input.context.id);
//console.log(inst.input.context.outerHTML);
//console.log(inst.input);
//console.log(this);
//console.log(this.markerClassName);
//inst.input.addClass(this.eventsMarkerClassName);
//console.log(EventDatepicker.eventsList);
//console.log(inst.input.context.className);
